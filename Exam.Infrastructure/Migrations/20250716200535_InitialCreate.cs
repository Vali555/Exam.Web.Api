    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamProcesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamProcesses_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExamProcesses_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamProcesses_LessonId",
                table: "ExamProcesses",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamProcesses_StudentId",
                table: "ExamProcesses",
                column: "StudentId");
